        ...
        <div className="max-w-[600px] mx-auto p-0 mt-[30px] mb-[60px]">
          <div className="grid grid-cols-12 items-baseline">
            <div className="col-span-8">
              <div className="px-2 pt-2 pb-0 text-3xl sm:text-[1.2rem] md:text-[1.4rem] lg:text-[1.5rem] font-bold text-left">
                adeeb ismail
              </div>
            </div>
            ...
            <div className="col-span-4 flex flex-row justify-end items-center gap-2 px-2 pt-2 pb-0">
              ...
              <div className="z text-sm md:text-[0.8rem] lg:text-[0.85rem] text-right">
            ...
            <div className="col-span-12">
              <div className="px-2 pt-1 pb-0 text-sm md:text-[0.8rem] lg:text-[0.85rem] text-left">
            ...
            <div className="col-span-12">
              <div className="px-2 pt-6 pb-2 text-base md:text-[0.9rem] lg:text-[0.95rem] font-bold text-left">
                experience
              </div>
            </div>
